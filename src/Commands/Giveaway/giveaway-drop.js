...
class command {
    constructor() {
        ...
        this.description = "Permets de lancer un Giveway instantanée.",
    ...
    async execute(bot, interaction) {
        ...
        if(!giveawayChannel.isTextBased()){
            return interaction.reply({
                embeds: [
                    Embed
                    .setDescription(`❌・**Le salons n'est pas un salons textuel** !`)
                ],
                ephemeral: true
            })
        }
        ...
        bot.giveawaysManager.start(giveawayChannel, {
            ...
            interaction.reply({
                embeds: [
                    Embed
                    .setDescription(`✅・**Le giveaway à été lancé dans ${giveawayChannel}** !`)
                ],
                ephemeral: true
            })
        }).catch((err) => {
